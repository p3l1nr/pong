...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void checkCollision() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        ...
        if (ball.y <= 0 || ball.y >= GAME_HEIGHT - BALL_DIAMETER-100) {//ball diameter affects the lower boundry
        ...
        File file = new File("C:\\Users\\Robert\\Desktop\\pong\\first paddle colision sound.wav");
        AudioInputStream audioStream = AudioSystem.getAudioInputStream(file);
        File fileTwo = new File("C:\\Users\\Robert\\Desktop\\pong\\second paddle collision sound.wav");
        AudioInputStream audioStreamTwo = AudioSystem.getAudioInputStream(fileTwo);
        Clip clip = AudioSystem.getClip();
        clip.open(audioStream);
        Clip clipTwo = AudioSystem.getClip();
        clipTwo.open(audioStreamTwo);
    ...
    private void handlePaddleCollision(Paddle paddle) {
        ...
        ball.setXDirection(paddle == paddle1 ? ball.xVelocity : -ball.xVelocity);
        ball.setYDirection(ball.yVelocity);
    }
